...
//Last modified: Wed, Feb 07, 2024 11:17:19 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "EC2C9AA5-4B9D-756E-D859-92B1F734455F";
createNode transform -s -n "persp";
	rename -uid "A1541D9C-480C-02E2-3E16-42B3F4243E3C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.5670904414538258 6.1344376381579657 -4.0824765977933879 ;
	setAttr ".r" -type "double3" -22.66438968275348 233.79999999999532 0 ;
	setAttr ".rp" -type "double3" 9.106159978880877e-19 0 1.8649415636748036e-15 ;
	setAttr ".rpt" -type "double3" 8.8865425472065585e-16 1.6319120545811308e-15 5.6601459314729665e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7.4761668064926967;
	setAttr ".ow" 0.32808398950131235;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 5.6843418860808015e-14 99.170547485351506 -0.2433013916015625 ;
...
createNode mesh -n "ChairShape" -p "Chair";
	...
	setAttr ".pv" -type "double2" 0.50189868295419693 0.5023312963276656 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 192 ".uvst[0].uvsp[0:191]" -type "float2" 0.081747651 0.95017868
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "567E2F37-497F-2D25-834E-35946AC378A4";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1585F119-43C3-6F79-28C2-CD81FAB6CFC9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C56D1160-4BD4-9477-03FA-C8A23D27FEE8";
createNode displayLayerManager -n "layerManager";
	rename -uid "A30789E4-408B-1D8E-A8EE-05956D9EB8B9";
createNode displayLayer -n "defaultLayer";
	rename -uid "F67E8D36-48EA-7F27-18D2-BCB49F03AFA9";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F40768B9-4871-103D-8834-86889DC43864";
...
createNode groupId -n "groupId1";
	rename -uid "6CE7FE0A-4C24-2D7E-78FE-ACA097D33C46";
	setAttr ".ihi" 0;
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "3AE49F5D-4BB0-66C2-4B23-5783E6F0915D";
